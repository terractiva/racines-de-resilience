...
const energyActions = [
	{
		...
		sources: [{ countrySlug: 'FR', name: `CLER`, link: `https://cler.org/outils/formation/` }]
	},
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `Enercoop`, link: `https://www.enercoop.fr/` },
			{ countrySlug: 'FR', name: `Greenpeace`, link: `https://www.guide-electricite-verte.fr/` }
		]
	},
	{
		...
		sources: [{ countrySlug: 'FR', name: `NégaWatt`, link: `https://negawatt.org/` }]
	},
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `Énergie Partagée`, link: `https://energie-partagee.org/` }
		]
	}
];
