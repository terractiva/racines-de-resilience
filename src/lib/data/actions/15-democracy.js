...
const democracyActions = [
	{
		...
		sources: [{ name: `Pacte Civique`, link: `https://pactecivique.fr/` }]
	},
	{
		...
		sources: [{ name: `ÉVEIL`, link: `https://www.eveil.asso.fr/` }]
	},
	{
		...
		sources: [
			{ name: `Démocratie Ouverte`, link: `https://www.democratieouverte.org/` },
			{ name: `CCC AURA`, link: `https://conventioncitoyenne-aura.fr/` }
		]
	},
	{
	...
	},
	{
		...
		sources: [
			{ name: `36000 Communes`, link: `https://36000communes.org/` },
			{ name: `Commonspolis`, link: `https://commonspolis.org/en/` }
		]
	},
	{
		...
		sources: [
			{ name: `Les Citoyens Constituants`, link: `https://www.lescitoyensconstituants.org/` }
		]
	}
];
