...
const conflictsActions = [
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `Coexister`, link: `https://www.coexister.fr/que-faisons-nous/` }
		]
	},
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `Université du Nous`, link: `https://universite-du-nous.org` }
		]
	},
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `MAN`, link: `https://nonviolence.fr/` },
			{ countrySlug: 'FR', name: `AFFCNV`, link: `https://www.cnvformations.fr/` },
			{
				countrySlug: 'FR',
				name: `EDUlib`,
				link: `https://mooc-francophone.com/cours/mooc-gestion-des-conflits/`
			}
		]
	},
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `MKP`, link: `https://www.mkpfrance.org/` },
			{ countrySlug: 'FR', name: `HeForShe`, link: `https://www.heforshe.org` }
		]
	},
	{
		...
		sources: [{ countrySlug: 'FR', name: `CYU`, link: `https://www.cyu.fr/du-ic#presentation` }]
	},
	{
		...
		sources: [
			{ countrySlug: 'FR', name: `Médiation Nomade`, link: `https://www.mediationnomade.fr/` },
			{ countrySlug: 'FR', name: `France Médiation`, link: `https://www.francemediation.fr/` }
		]
	}
];
