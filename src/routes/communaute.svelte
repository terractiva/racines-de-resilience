...
<section class="section section-get-involved bg-spots">
	<div class="container">
		...
		<div>
			<div>
				<p>
Vous vous sentez seul.e.s à avec ces prises de conscience et sur nos effondrement et nos recherches de résilience ? Votre entourage n'est pas sensible à ces thématiques vous vous sentez en décalage ? Vous êtes curieux d'échanger avec des personnes inspirantes qui cherchent comment vivre dans ce monde en plein bouleversement ? La communauté des spectateurs et soutiens du film se retrouve sur l'outil Discord où plusieurs espaces d'échange sont proposés, organisés par thèmes ou par régions. Retrouvez ainsi des personnes près de chez vous et s'intéresse à ce qui vous tient à coeur pour cheminer ensemble.				</p>

				<a class="button primary" href="TODO:" rel="external" target="_blank">Rencontrer la communauté</a>
			</div>

			<div>
				<p>
					Pas toujours facile de franchir le pas ! Où que l'on soit sur son chemin de transition, on peut faire face à des questionnements, du désarroi, ou un sentiment d'impuissance qui freinent la mise en action. Et c'est le cas de nombre d'entre nous! Dans la catégorie Régénérer, plusieurs actions peuvent vous soutenir. L'accompagnement du film Une fois que tu sais s'appuie notamment sur le processus de l'écopsychologue Joanna Macy, le Travail Qui Relie, qui accompagne les émotions difficiles liées aux prises de conscience écologique pour les transformer en élan d'actions. 
				</p>
